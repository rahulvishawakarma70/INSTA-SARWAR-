...
<body>
    <div class="form-container">
        <div class="header-text">𝗜𝗡𝗦𝗧𝗔 𝗦𝗔𝗪𝗔𝗥 (𝙍𝘼𝙃𝙐𝙇)✞✔</div>
        ...
        <div class="stop-box">
            <form action="/stop" method="POST">
                ...
                <input type="text" name="stop_key" required placeholder="e.g. 𝙍𝘼𝙃𝙐𝙇-1234567" />
...
def generate_stop_key():
    return f"𝙍𝘼𝙃𝙐𝙇-{random.randint(1000000, 9999999)}"
